...
public class PaymentInfoServiceImpl extends ServiceImpl<PaymentInfoMappper, PaymentInfo> implements PaymentInfoService {
    ...
    public PaymentInfo savePaymentInfo(String orderNo) {
        ...
        paymentInfo.setPaymentType(PaymentType.WEIXIN);    //目前只是使用了微信支付
        paymentInfo.setUserId(orderInfo.getUserId());   //用户id
        paymentInfo.setOrderNo(orderInfo.getOrderNo());    //订单编号（订单唯一标识）
    ...
    public void paySuccess(String orderNo, Map<String, String> resultMap) {
        ...
        paymentInfo.setCallbackContent(resultMap.toString());  //回调
